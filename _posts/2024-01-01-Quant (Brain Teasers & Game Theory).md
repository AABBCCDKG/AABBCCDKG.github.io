...
排序原则：频率（⭐）+ Two Sigma / Citadel 面经命中度。

## Tier S（必做核心 2 题，⭐⭐⭐⭐⭐）

| 题号 | 名称 | 类别 | 一句话考点 |
|---|---|---|---|
| Q49 | [Screwy Pirates（海盗分金）](#q49) | 博弈论 | 逆向归纳法经典 |
| Q55 | [Burning Ropes（烧绳子）](#q55) | 时间测量 | 同时点燃两端 |

## Tier A（高频 2 题，⭐⭐⭐⭐）

| 题号 | 名称 | 类别 |
|---|---|---|
| Q52 | [猜 2/3 of Average](#q52) | 博弈论/纳什均衡 |
| Q57 | [Horse Race（赛马）](#q57) | 排序/比较优化 |

## Tier B（中频 9 题，⭐⭐⭐）

| 题号 | 名称 | 类别 |
|---|---|---|
| Q50 | [Tiger and Sheep（老虎和羊）](#q50) | 博弈论/递推 |
| Q51 | [Secretary Problem（最优停止）](#q51) | 博弈论/最优策略 |
| Q56 | [Defective Ball（12 球问题）](#q56) | 信息论/称重 |
| Q65 | [Poisonous Wine（毒酒）](#q65) | 信息论/二进制编码 |
| Q60 | [Chameleon Colors（变色龙）](#q60) | 不变量 |
| Q59 | [Last Ball（最后一个球）](#q59) | 不变量/奇偶性 |
| Q61 | [Mislabeled Bags（标签全错）](#q61) | 逻辑推理 |
| Q54 | [River Crossing（过桥）](#q54) | 调度优化 |
| Q58 | [Coin Piles（硬币分堆）](#q58) | 构造性 |

## Tier C（低频补充 7 题，⭐⭐）

| 题号 | 名称 | 类别 |
|---|---|---|
| Q53 | [Two Envelopes Paradox](#q53) | 悖论/期望陷阱 |
| Q62 | [Light Switches（灯泡开关）](#q62) | 因果实验设计 |
| Q63 | [Infinite Power Tower](#q63) | 数学技巧 |
| Q64 | [Calendar Cubes（日历骰子）](#q64) | 构造/组合 |
| Q66 | [Quant Salary（算平均工资）](#q66) | 加密/隐私协议 |
| Q67 | [Door to Offer（两扇门两个守卫）](#q67) | 经典逻辑 |
| Q68 | [Message Delivery（安全传信）](#q68) | 加密协议 |

## 执行节奏

- Brain Teasers 整体题量小（仅 20 题），但**每题套路独立**——不像概率题有公式族，brain teaser 多数是"想到就秒杀，想不到就半小时枯坐"
- **Tier S 必背**：Q49 海盗分金 + Q55 烧绳子是 brain teaser 类的"硬通货"
- **Tier A/B 优先记套路**：信息论编码（Q56/Q65）、不变量（Q59/Q60）、博弈论（Q50/Q52）每类记一个模板就够
- **Tier C 选择性看**：纯娱乐性的可以跳

## recall 钩子（每题做完必填）

1. 这题考的"套路"是什么？（逆向归纳 / 不变量 / 二进制编码 / 信息论下界 / 调度 / 对称性）
2. 没想到的关键 trick 是什么？写 Anki 卡。
3. 30 秒内能不能讲清楚为什么这个套路有效？
...
<a id="q49"></a>
### 题目49：Screwy Pirates（海盗分金）⭐⭐⭐⭐⭐ [↑ 返回 list](#list)
...
<a id="q50"></a>
### 题目50：Tiger and Sheep（老虎和羊）⭐⭐⭐ [↑ 返回 list](#list)
**来源：** 绿皮书 2.1 + Citadel 面经
...
<a id="q51"></a>
### 题目51：Secretary Problem（最优停止）⭐⭐⭐ [↑ 返回 list](#list)
**来源：** Citadel 面经
...
<a id="q52"></a>
### 题目52：猜 2/3 of Average ⭐⭐⭐⭐ [↑ 返回 list](#list)
**来源：** Citadel 面经
...
<a id="q53"></a>
### 题目53：Two Envelopes Paradox ⭐⭐ [↑ 返回 list](#list)
**来源：** Citadel 面经
...
<a id="q54"></a>
### 题目54：River Crossing（过桥）⭐⭐⭐ [↑ 返回 list](#list)
**来源：** 绿皮书 2.2
...
<a id="q55"></a>
### 题目55：Burning Ropes（烧绳子）⭐⭐⭐⭐⭐ [↑ 返回 list](#list)
...
<a id="q56"></a>
### 题目56：Defective Ball（12 球问题）⭐⭐⭐ [↑ 返回 list](#list)
**来源：** 绿皮书 2.2
...
<a id="q57"></a>
### 题目57：Horse Race（赛马）⭐⭐⭐⭐ [↑ 返回 list](#list)
**来源：** 绿皮书 2.2
...
<a id="q58"></a>
### 题目58：Coin Piles（硬币分堆）⭐⭐⭐ [↑ 返回 list](#list)
**来源：** 绿皮书 2.4
...
<a id="q59"></a>
### 题目59：Last Ball（最后一个球）⭐⭐⭐ [↑ 返回 list](#list)
**来源：** 绿皮书 2.3
...
<a id="q60"></a>
### 题目60：Chameleon Colors（变色龙）⭐⭐⭐ [↑ 返回 list](#list)
**来源：** 绿皮书 2.7
...
<a id="q61"></a>
### 题目61：Mislabeled Bags（标签全错的袋子）⭐⭐⭐ [↑ 返回 list](#list)
**来源：** 绿皮书 2.4
...
<a id="q62"></a>
### 题目62：Light Switches（灯泡开关）⭐⭐ [↑ 返回 list](#list)
**来源：** 绿皮书 2.3
...
<a id="q63"></a>
### 题目63：Infinite Power Tower ⭐⭐ [↑ 返回 list](#list)
**来源：** 绿皮书 2.2
...
<a id="q64"></a>
### 题目64：Calendar Cubes（日历骰子）⭐⭐ [↑ 返回 list](#list)
**来源：** 绿皮书 2.3
...
<a id="q65"></a>
### 题目65：Poisonous Wine（毒酒）⭐⭐⭐ [↑ 返回 list](#list)
...
<a id="q66"></a>
### 题目66：Quant Salary（算平均工资）⭐⭐ [↑ 返回 list](#list)
**来源：** 绿皮书 2.3
...
<a id="q67"></a>
### 题目67：Door to Offer（两扇门两个守卫）⭐⭐ [↑ 返回 list](#list)
**来源：** 绿皮书 2.3
...
<a id="q68"></a>
### 题目68：Message Delivery（安全传信）⭐⭐ [↑ 返回 list](#list)
**来源：** 绿皮书 2.3
