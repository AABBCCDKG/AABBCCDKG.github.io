...
Binary Search Tree:
- Average case: O(log n) when the tree is approximately balanced (each comparison eliminates about half of the remaining nodes).
- Worst case: O(n) if the tree becomes completely unbalanced (degenerates into a chain).
